...
/**
 * Maps (vendor id, product id) pairs to the corresponding serial com.example.driver.
 *
...
public class ProbeTable {
     ...
     * @param driverClass the com.example.driver class responsible for this pair
    ...
    /**
     * Returns the com.example.driver for the given (vendor, product) pair, or {@code null}
     * if no match.
     *
     * @param vendorId  the USB vendor id
     * @param productId the USB product id
     * @return the com.example.driver class matching this pair, or {@code null}
     */
