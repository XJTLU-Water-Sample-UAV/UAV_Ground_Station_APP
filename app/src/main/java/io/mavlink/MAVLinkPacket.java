...
import io.mavlink.ASLUAV.msg_asl_obctrl;
import io.mavlink.ASLUAV.msg_aslctrl_data;
import io.mavlink.ASLUAV.msg_aslctrl_debug;
import io.mavlink.ASLUAV.msg_asluav_status;
import io.mavlink.ASLUAV.msg_command_int_stamped;
import io.mavlink.ASLUAV.msg_command_long_stamped;
import io.mavlink.ASLUAV.msg_ekf_ext;
import io.mavlink.ASLUAV.msg_fw_soaring_data;
import io.mavlink.ASLUAV.msg_gsm_link_status;
import io.mavlink.ASLUAV.msg_satcom_link_status;
import io.mavlink.ASLUAV.msg_sens_atmos;
import io.mavlink.ASLUAV.msg_sens_batmon;
import io.mavlink.ASLUAV.msg_sens_mppt;
import io.mavlink.ASLUAV.msg_sens_power;
import io.mavlink.ASLUAV.msg_sens_power_board;
import io.mavlink.ASLUAV.msg_sensor_airflow_angles;
import io.mavlink.ASLUAV.msg_sensorpod_status;
import io.mavlink.AVSSUAS.msg_avss_prs_sys_status;
import io.mavlink.Messages.MAVLinkMessage;
import io.mavlink.Messages.MAVLinkPayload;
import io.mavlink.all.CRC;
import io.mavlink.ardupilotmega.msg_adap_tuning;
import io.mavlink.ardupilotmega.msg_ahrs;
import io.mavlink.ardupilotmega.msg_ahrs2;
import io.mavlink.ardupilotmega.msg_ahrs3;
import io.mavlink.ardupilotmega.msg_airspeed_autocal;
import io.mavlink.ardupilotmega.msg_aoa_ssa;
import io.mavlink.ardupilotmega.msg_ap_adc;
import io.mavlink.ardupilotmega.msg_autopilot_version_request;
import io.mavlink.ardupilotmega.msg_battery2;
import io.mavlink.ardupilotmega.msg_camera_feedback;
import io.mavlink.ardupilotmega.msg_camera_status;
import io.mavlink.ardupilotmega.msg_compassmot_status;
import io.mavlink.ardupilotmega.msg_data16;
import io.mavlink.ardupilotmega.msg_data32;
import io.mavlink.ardupilotmega.msg_data64;
import io.mavlink.ardupilotmega.msg_data96;
import io.mavlink.ardupilotmega.msg_deepstall;
import io.mavlink.ardupilotmega.msg_device_op_read;
import io.mavlink.ardupilotmega.msg_device_op_read_reply;
import io.mavlink.ardupilotmega.msg_device_op_write;
import io.mavlink.ardupilotmega.msg_device_op_write_reply;
import io.mavlink.ardupilotmega.msg_digicam_configure;
import io.mavlink.ardupilotmega.msg_digicam_control;
import io.mavlink.ardupilotmega.msg_ekf_status_report;
import io.mavlink.ardupilotmega.msg_esc_telemetry_1_to_4;
import io.mavlink.ardupilotmega.msg_esc_telemetry_5_to_8;
import io.mavlink.ardupilotmega.msg_esc_telemetry_9_to_12;
import io.mavlink.ardupilotmega.msg_fence_fetch_point;
import io.mavlink.ardupilotmega.msg_fence_point;
import io.mavlink.ardupilotmega.msg_gimbal_control;
import io.mavlink.ardupilotmega.msg_gimbal_report;
import io.mavlink.ardupilotmega.msg_gimbal_torque_cmd_report;
import io.mavlink.ardupilotmega.msg_gopro_get_request;
import io.mavlink.ardupilotmega.msg_gopro_get_response;
import io.mavlink.ardupilotmega.msg_gopro_heartbeat;
import io.mavlink.ardupilotmega.msg_gopro_set_request;
import io.mavlink.ardupilotmega.msg_gopro_set_response;
import io.mavlink.ardupilotmega.msg_hwstatus;
import io.mavlink.ardupilotmega.msg_led_control;
import io.mavlink.ardupilotmega.msg_limits_status;
import io.mavlink.ardupilotmega.msg_mag_cal_progress;
import io.mavlink.ardupilotmega.msg_mcu_status;
import io.mavlink.ardupilotmega.msg_meminfo;
import io.mavlink.ardupilotmega.msg_mount_configure;
import io.mavlink.ardupilotmega.msg_mount_control;
import io.mavlink.ardupilotmega.msg_mount_status;
import io.mavlink.ardupilotmega.msg_obstacle_distance_3d;
import io.mavlink.ardupilotmega.msg_osd_param_config;
import io.mavlink.ardupilotmega.msg_osd_param_config_reply;
import io.mavlink.ardupilotmega.msg_osd_param_show_config;
import io.mavlink.ardupilotmega.msg_osd_param_show_config_reply;
import io.mavlink.ardupilotmega.msg_pid_tuning;
import io.mavlink.ardupilotmega.msg_radio;
import io.mavlink.ardupilotmega.msg_rally_fetch_point;
import io.mavlink.ardupilotmega.msg_rally_point;
import io.mavlink.ardupilotmega.msg_rangefinder;
import io.mavlink.ardupilotmega.msg_remote_log_block_status;
import io.mavlink.ardupilotmega.msg_remote_log_data_block;
import io.mavlink.ardupilotmega.msg_rpm;
import io.mavlink.ardupilotmega.msg_sensor_offsets;
import io.mavlink.ardupilotmega.msg_set_mag_offsets;
import io.mavlink.ardupilotmega.msg_simstate;
import io.mavlink.ardupilotmega.msg_vision_position_delta;
import io.mavlink.ardupilotmega.msg_water_depth;
import io.mavlink.ardupilotmega.msg_wind;
import io.mavlink.common.*;
import io.mavlink.development.msg_airspeed;
import io.mavlink.development.msg_group_end;
import io.mavlink.development.msg_group_start;
import io.mavlink.development.msg_mission_changed;
import io.mavlink.development.msg_mission_checksum;
import io.mavlink.development.msg_param_ack_transaction;
import io.mavlink.development.msg_wifi_network_info;
import io.mavlink.icarous.msg_icarous_heartbeat;
import io.mavlink.icarous.msg_icarous_kinematic_bands;
import io.mavlink.minimal.msg_heartbeat;
import io.mavlink.minimal.msg_protocol_version;
import io.mavlink.python_array_test.msg_array_test_0;
import io.mavlink.python_array_test.msg_array_test_1;
import io.mavlink.python_array_test.msg_array_test_3;
import io.mavlink.python_array_test.msg_array_test_4;
import io.mavlink.python_array_test.msg_array_test_5;
import io.mavlink.python_array_test.msg_array_test_6;
import io.mavlink.python_array_test.msg_array_test_7;
import io.mavlink.python_array_test.msg_array_test_8;
import io.mavlink.storm32.msg_component_prearm_status;
import io.mavlink.storm32.msg_qshot_status;
import io.mavlink.storm32.msg_storm32_gimbal_device_control;
import io.mavlink.storm32.msg_storm32_gimbal_device_status;
import io.mavlink.storm32.msg_storm32_gimbal_manager_control;
import io.mavlink.storm32.msg_storm32_gimbal_manager_control_pitchyaw;
import io.mavlink.storm32.msg_storm32_gimbal_manager_correct_roll;
import io.mavlink.storm32.msg_storm32_gimbal_manager_information;
import io.mavlink.storm32.msg_storm32_gimbal_manager_profile;
import io.mavlink.storm32.msg_storm32_gimbal_manager_status;
import io.mavlink.test.msg_test_types;
import io.mavlink.uAvionix.msg_uavionix_adsb_out_cfg;
import io.mavlink.uAvionix.msg_uavionix_adsb_out_dynamic;
import io.mavlink.uAvionix.msg_uavionix_adsb_transceiver_health_report;
import io.mavlink.ualberta.msg_nav_filter_bias;
import io.mavlink.ualberta.msg_radio_calibration;
import io.mavlink.ualberta.msg_ualberta_sys_status;
